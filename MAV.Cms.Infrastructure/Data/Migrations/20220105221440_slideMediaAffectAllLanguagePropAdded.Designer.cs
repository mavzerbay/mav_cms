...
namespace MAV.Cms.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220105221440_slideMediaAffectAllLanguagePropAdded")]
    partial class slideMediaAffectAllLanguagePropAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAV.Cms.Domain.Entities.GeneralSettings", b =>
                {
                    ...
                    b.Property<Guid?>("LatestProjectPageId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("LatestProjectPageId");
            ...
            modelBuilder.Entity("MAV.Cms.Domain.Entities.GeneralSettingsTrans", b =>
                {
                    ...
                    b.Property<string>("ContactOgKeywords")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("HomeOgKeywords")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("MAV.Cms.Domain.Entities.SlideMedia", b =>
                {
                    ...
                    b.Property<bool>("AffectAllLanguage")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("MAV.Cms.Domain.Entities.GeneralSettings", b =>
                {
                    b.HasOne("MAV.Cms.Domain.Entities.Page", "LatestProjectPage")
                        .WithMany()
                        .HasForeignKey("LatestProjectPageId");

                    b.HasOne("MAV.Cms.Domain.Entities.Slide", "TestimonialSlide")
                        .WithMany()
                        .HasForeignKey("TestimonialSlideId");

                    b.Navigation("LatestProjectPage");
