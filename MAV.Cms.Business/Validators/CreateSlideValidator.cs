...
{
    public class CreateSlideValidator : AbstractValidator<CreateSlideDTO>
    {
        public CreateSlideValidator()
        {
            ...
            RuleForEach(x => x.SlideMedias).Where(x => LangManager.IsPrimaryLanguage(x.LanguageId)).SetValidator(new CreateSlideMediaValidator());
        }
    }
}
