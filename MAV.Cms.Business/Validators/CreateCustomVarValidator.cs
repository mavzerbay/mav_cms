...
{
    public class CreateCustomVarValidator : AbstractValidator<CreateCustomVarDTO>
    {
        public CreateCustomVarValidator()
        {
            ...
            RuleForEach(x => x.CustomVarTrans).Where(x => LangManager.IsPrimaryLanguage(x.LanguageId)).SetValidator(new CreateCustomVarTransValidator());
        }
    }
}
