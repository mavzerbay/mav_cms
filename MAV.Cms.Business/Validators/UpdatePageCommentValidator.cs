...
{
    public class UpdatePageCommentValidator : AbstractValidator<UpdatePageCommentDTO>
    {
        public UpdatePageCommentValidator()
        {
            RuleFor(x => x.Id)
                .NotEmpty().WithMessage(string.Format(LangManager.Translate("Common.Required"), LangManager.Translate("PageComment.ControllerTitle")));
